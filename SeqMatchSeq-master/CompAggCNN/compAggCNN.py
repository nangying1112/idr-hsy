...
class compAggWikiqa(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.soft_module = TempNet(150)
        self.rl_soft_module = TempNet(300)
    ...
    def forward(self, data_q, data_as,data_as_len):
        ...
        conv_output,soft_output = self.comp_agg(data_q,data_as,data_as_len)
        # get rl state
        rl_state = self.rl_state(data_q,data_as,data_as_len,conv_output,soft_output)
