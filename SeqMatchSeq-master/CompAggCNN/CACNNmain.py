...
parser.add_argument('--lr', type=float, default=5e-4, help='learning rate decay ratio')
parser.add_argument('--lr_decay', type=float, default=0.95, help='learning rate decay ratio')
parser.add_argument('--dropoutP', type=float, default=0.1, help='dropout ratio')
...
parser.add_argument('--pretrain_type', type=bool, default=True, help='rl_pretrain: true or supervised pretrain:false')
