...
class pddata():
    def __init__(self, relation=None, seq_length=50):
        ...
        self.rel = relation
        self.arg1_max_len = seq_length
        self.arg2_max_len = seq_length
        # self.samples = None
        self.train = None
        self.test = None
    ...
    def next_single_rel(self, batch_size, type):
        ...
        # print('arg1',[len(one) for one in arg1])
        return arg1, arg2, arg1_len, arg2_len, label, self.arg1_max_len, self.arg2_max_len
    ...
    def get_arg_len(self):
        ...
        return self.arg1_max_len, self.arg2_max_len
